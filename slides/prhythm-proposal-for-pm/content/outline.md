...
| 2 | 02-challenge.html | s-content | 課題意識 | stack+duo | 表層（単価2倍で開発取れない）→本質（志向性ミスマッチ×心理的ハードル） |
| 3 | 03-prhythm-answer.html | s-content | Prhythmとは | answer | 課題への答えとして、瞬作のスキルセットと提案での使い方をセットで提供する |
| 4 | 04-pm-moments.html | s-content | PMに効く2つの瞬間 | two-entry | ACN提案と既存案件の次期計画という2つの入口を示す |
...
| 15 | 07-vision.html | s-content | PMの未来 | role cycle | 次の一手、協働、意思決定、継続提案という4つの役割が循環するPMの未来を示す |
| 16 | 07z-summary.html | s-content | まとめ | takeaway overview | 2つの入口、協働の役割、8スキル、成果物、価値を一枚で振り返る |
